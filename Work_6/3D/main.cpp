...
void Init_Light(float angleRot)
{
    ...
    GLfloat light_position[] = { 4.0f, 0.0f, 3.0f, 1.0f }; //позиция источника
    ...
    glLightf(GL_LIGHT0, GL_SPOT_CUTOFF, 80); // конус для направленного источника

    glLightfv(GL_LIGHT0, GL_SPOT_DIRECTION, light_spot_direction);
    glLightf(GL_LIGHT0, GL_SPOT_EXPONENT, 8.0); // экспонента убывания интенсивности
